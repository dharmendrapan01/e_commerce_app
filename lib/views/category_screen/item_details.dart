                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                5.heightBox,
                                "${data['p_seller']}".text.color(darkFontGrey).size(16).make(),
                              ],
                            ),
                          ),
                          const CircleAvatar(
                      ...
                      ListView(
                        ...
                        shrinkWrap: true,
                        children: List.generate(itemsButtonsDetailsList.length, (index) => ListTile(
                          title: itemsButtonsDetailsList[index].text.fontFamily(semibold).color(darkFontGrey).make(),
